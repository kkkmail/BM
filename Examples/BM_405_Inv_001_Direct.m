PathList={"C:\\Math\\", "C:\\"};
BaseDir="C:\\Math\\"; BaseFileName="TCINV_"; OutDir=BaseDir <>"Calc\\"; OutFileName="TEST_300_1.CSV";
(*==============================================*)
useParallelTbl=True;
...
lambda={600,600,0.01,"Lambda",nm};fita={0,75,15,"Fita", Degree};beta={0, 90, 90,"Beta", Degree};gamm={-90, 90, 30,"Gamma", Degree};ellipt={0,0,1,"ellipticity"};
...
VarList=VarListAddLayer[VarList, {fi1, theta1, psi1, thk1}];Layer = FilmLayerNew[thck1, eps1]; Film =FilmAddLayer[Film, Layer];
 (* VarList=VarListAddLayer[VarList, {fi2, theta2, psi2, thk2}];Layer = FilmLayerNew[thck2, eps2]; Film =FilmAddLayer[Film, Layer]; *)
(*==============================================*)
...
(* CalcInfiniteGlass=CalcNew[MediaInfiniteGlass, VarListInfiniteGlass, FuncList, FuncNameList, "1 layer", PrintTimeEstimate  False]; *)

coll=CalcCollectionNew[BaseDir, BaseFileName, "No Description so far."];
CalcCollectionAddCalc[coll, Calc];
(* coll=CalcCollectionAddCalc[coll, CalcInfiniteGlass]; *)
(* coll=CalcCollectionAddCalc[coll, CalcCombRot]; *)
