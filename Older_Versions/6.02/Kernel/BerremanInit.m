...
(* ============================================== *)
Initialize[pathList_]:=Initialize[pathList, True];
(* ============================================== *)
Initialize[pathList_, useParallelTbl_,optsRaw___]:=Module[{pathVar,  useParTbl,opts},
