...
(* ============================================== *)
Options[FieldIO]={FieldIOVersion -> 6.02,FieldIOFormatVersion -> 6.02};
(* ============================================== *)
BMVersionMain="6.02.001";
BMReleaseDateMain="2016/04/12";
BMCopyrightStr="Copyright: K^3, 2001 - 2016.";
...
(* ============================================== *)
OutputFunc[Calc_,fName_:"",OverWrite_:True]:=Module[{funcnames,varnames,inpt,outpt,len,width,idxarr,blankarr,OutList,OutListOnly,OutHead,OutFullList,OutFooter,funcnamesOrig,varnamesOrig},
...
(* ============================================== *)
PrepareHeader[Calc_]:=Module[{OutFullList,Media,n1,n2,Film,mDescr,flmLen,optBlk,nOut,eps,mu,ro,mHlp1,mHlp2,mHlp3,epsHlp,muHlp,roHlp,roTHlp,roT},
...
(* ============================================== *)
PrepareFooter[Calc_]:=Module[{},strOutputBlockFooter="*** End Output Block ***";
...
(* ============================================== *)
PrepareOptionsBlock[Calc_]:=Module[{retval,OA,opts,optval},OA=Flatten[{Options[BerremanCommon],Options[BerremanDirect]}];
...
(* ============================================== *)
ToEnglish[var_]:=Module[{retval,len,ltArr,i,lt,str, prevCRLF},
str=ToString[var];
...
(* ============================================== *)
GreekLetterMap[ltVar_]:=Module[{retval,lt},
lt=ToString[ltVar];
...
(* ============================================== *)
GetRotationInfo[Calc_]:=Module[{retVal,opts,useEulerAng},
opts =CalcOptions[Calc];
...
(* ============================================== *)
GetFullVersionInfo[]:=Module[{retVal},
...
(* ============================================== *)
OutputThickLastLayerInfo[]:=Module[{},
Print[strSeparator];
...
(* ============================================== *)
OutputThickLastLayerInfo[Calc_]:=Module[{opts,uTLL},
opts =CalcOptions[Calc];
uTLL= UseThickLastLayer /. opts /.Options[BerremanDirect];
];
(* ============================================== *)
OutputIncidentRayInfo[ray_?IncidentRayQ]:=Module[{light,output,names},
...
Print["Upper refractive index ", Subscript["n","u"], " = ", IncidentLighRefrIndex[light], ", parameters: ", output // MatrixForm];
...
(* ============================================== *)
OutputIncidentRayInfo[ray___]:=Module[{},
Print["OutputIncidentRayInfo::Invalid IncidentRay: ", ray];
];
(* ============================================== *)
OutputLayeredSystem[layeredSystem_?LayeredSystemQ]:=Module[{},
Print["Layered System = ", layeredSystem];
Print[strSeparator];
];
(* ============================================== *)
OutputLayeredSystem[layeredSystem___]:=Module[{},
