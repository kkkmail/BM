...
(* ============================================== *)
Options[OpticalModel] =
    {
      OpticalModelVersion -> 6.04
    };
(* ============================================== *)
...
(* ============================================== *)
CreateOpticalModel[description_, funcList_, opts___] :=
    Module[{model, elemList},
      elemList = {};
...
ModelSetElementList[model_, elementListNew : {___}] :=
    Module[{},
...
ModelAddOpticalElement[model_, element_] :=
    Module[{elementList, elementListNew},
...
(* ============================================== *)
ModelGetVarList[model_] :=
    Module[{elemList, callTbl, element, len, ii, getVarListFunc, varLst, varLstAll},
...
(* ============================================== *)
ModelCalculateMuellerMatrix[model_, varValueLst_?VectorQ] :=
    Module[{muellerMatrix, muellerMatrixTotal, len, ii, jj, elemList, element, callTbl, funcPointer, elemValueList, dataTbl, elemVarLen, elemVarStartIdx},
...
(* ============================================== *)
StokesVectorNew[varList : {{___}, ___}] :=
    Module[{sVec},
      sVec = 0;
      Return[sVec];
    ];
(* ============================================== *)
StokesVectorNew[s0_, s1_, s2_, s3_] :=
    Module[{sVec},
...
*)
(* ============================================== *)
CallTableGetMember[callTbl_?MatrixQ, memberName_] :=
    Module[{member, len, ii},
...
(* ============================================== *)
CheckClassName[element_, clsNameList_?VectorQ] :=
    Module[{clsName, len, ii},
...
(* ============================================== *)
CheckClassName[element_, clsName_] :=
    Module[{callTbl, len, ii, retVal, member},
      callTbl = ElementGetCallTable[element];
      (*
